...
LOT_SIZE = INSTRUMENT_PROPERTIES[SYMBOL]["lot_size"]
STRIKE_STEP = INSTRUMENT_PROPERTIES[SYMBOL]["strike_step"]
...
class Backtester:
    ...
    def _execute_trade(self, row, opt_type):
        ...
        # Floor division to get number of full lots
        num_lots = int(max_investment / (self.entry_price * LOT_SIZE))
