...
# Risk Management
# Instead of using the entire account balance, restrict the max capital to 50k
...
class RiskManager:
    def __init__(self, broker: BrokerAPI):
        ...
        # Dynamic Kill Switch calculation based on allocated capital
        self.starting_capital = ALLOCATED_CAPITAL
...
class ScalpingStrategy:
    ...
    def execute_trade(self, opt_type, spot_price, adx_value):
        ...
        available_capital = min(live_balance, ALLOCATED_CAPITAL)

        # Use 95% of available capital
        max_investment = available_capital * 0.95
